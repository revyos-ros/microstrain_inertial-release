## microstrain_inertial (jazzy) - 4.7.0-1

The packages in the `microstrain_inertial` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy microstrain_inertial --override-release-repository-push-url git@github.com:revyos-ros/microstrain_inertial-release.git` on `Wed, 18 Jun 2025 07:05:35 -0000`
...
- release repository: https://github.com/revyos-ros/microstrain_inertial-release.git
...
## microstrain_inertial (humble) - 4.7.0-1

The packages in the `microstrain_inertial` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r humble microstrain_inertial --override-release-repository-push-url git@github.com:revyos-ros/microstrain_inertial-release.git` on `Mon, 16 Jun 2025 05:18:48 -0000`
...
The packages in the `microstrain_inertial` repository were released into the `jazzy` distro by running `/tmp/venv/bin/bloom-release -r jazzy microstrain_inertial --override-release-repository-push-url git@github.com:revyos-ros/microstrain_inertial-release.git` on `Sun, 15 Dec 2024 11:40:47 -0000`
...
The packages in the `microstrain_inertial` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r humble microstrain_inertial --override-release-repository-push-url git@github.com:revyos-ros/microstrain_inertial-release.git` on `Sat, 14 Dec 2024 07:50:55 -0000`
...
The packages in the `microstrain_inertial` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r jazzy microstrain_inertial --override-release-repository-push-url git@github.com:revyos-ros/microstrain_inertial-release.git` on `Wed, 09 Oct 2024 10:14:05 -0000`
...
The packages in the `microstrain_inertial` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r humble microstrain_inertial --override-release-repository-push-url git@github.com:revyos-ros/microstrain_inertial-release.git` on `Tue, 08 Oct 2024 07:00:39 -0000`
...
## microstrain_inertial (jazzy) - 4.3.0-2

The packages in the `microstrain_inertial` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy microstrain_inertial --override-release-repository-push-url git@github.com:revyos-ros/microstrain_inertial-release` on `Wed, 19 Jun 2024 04:58:34 -0000`
...
## microstrain_inertial (humble) - 4.3.0-2

The packages in the `microstrain_inertial` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release --rosdistro humble microstrain_inertial` on `Tue, 28 May 2024 05:50:43 -0000`
